...
@NgModule({
  declarations: [AppComponent, ListcarComponent, AdminhomeComponent,AddcarComponent, EditcarComponent, DeletecarComponent, DeleteConfirmationComponentComponent, AdminhomeComponent, ReservationlistComponent],
  imports: [
    BrowserModule,
    FormsModule,
    ReactiveFormsModule,
